...
public record WorkOrderResponse(Long workOrderId, VehicleResponse vehicleResponse, WorkOrderStatus workOrderStatus, TechnicianDTO technicianDto, String problem, LocalDateTime submitTime, double progress, String progressDescription) {
